...
export class GlobalDurableObject extends DurableObject {
    ...
    async getCalculatorData(): Promise<CalculatorData> {
      ...
      const data: CalculatorData = {
        ...
        contextText: "Disgraced former Police Commissioner Andrew Coster may be off the job, but he’s still on the payroll. The Costly Coster Calculator shows how much taxpayers are forking out every second he remains in the job.",
      };
      return data;
    }
}